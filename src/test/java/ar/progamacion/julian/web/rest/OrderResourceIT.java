package ar.progamacion.julian.web.rest;

import static ar.progamacion.julian.web.rest.TestUtil.sameInstant;
import static org.assertj.core.api.Assertions.assertThat;
import static org.hamcrest.Matchers.hasItem;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import ar.progamacion.julian.IntegrationTest;
...
class OrderResourceIT {
    ...
    void createOrder() throws Exception {
        ...
        assertThat(testOrder.getCliente()).isEqualTo(DEFAULT_CLIENTE);
        assertThat(testOrder.getAccionId()).isEqualTo(DEFAULT_ACCION_ID);
        assertThat(testOrder.getAccion()).isEqualTo(DEFAULT_ACCION);
        assertThat(testOrder.getOperacion()).isEqualTo(DEFAULT_OPERACION);
        assertThat(testOrder.getPrecio()).isEqualTo(DEFAULT_PRECIO);
        assertThat(testOrder.getCantidad()).isEqualTo(DEFAULT_CANTIDAD);
        assertThat(testOrder.getFechaOperacion()).isEqualTo(DEFAULT_FECHA_OPERACION);
        assertThat(testOrder.getModo()).isEqualTo(DEFAULT_MODO);
    }
    ...
    void putExistingOrder() throws Exception {
        ...
        Order testOrder = orderList.get(orderList.size() - 1);
        assertThat(testOrder.getCliente()).isEqualTo(UPDATED_CLIENTE);
        assertThat(testOrder.getAccionId()).isEqualTo(UPDATED_ACCION_ID);
        assertThat(testOrder.getAccion()).isEqualTo(UPDATED_ACCION);
        assertThat(testOrder.getOperacion()).isEqualTo(UPDATED_OPERACION);
        assertThat(testOrder.getPrecio()).isEqualTo(UPDATED_PRECIO);
        assertThat(testOrder.getCantidad()).isEqualTo(UPDATED_CANTIDAD);
        assertThat(testOrder.getFechaOperacion()).isEqualTo(UPDATED_FECHA_OPERACION);
        assertThat(testOrder.getModo()).isEqualTo(UPDATED_MODO);
    }
