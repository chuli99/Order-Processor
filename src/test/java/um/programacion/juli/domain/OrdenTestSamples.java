...
public class OrdenTestSamples {
    ...
    public static Orden getOrdenSample1() {
        return new Orden().id(1L).cliente(1).accion("accion1").operacion("operacion1").cantidad(1).modo("modo1");
    }

    public static Orden getOrdenSample2() {
        return new Orden().id(2L).cliente(2).accion("accion2").operacion("operacion2").cantidad(2).modo("modo2");
    }
