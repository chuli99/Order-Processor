...
import static um.ar.prog.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import um.ar.prog.config.Constants;
import um.ar.prog.domain.User;
import um.ar.prog.repository.AuthorityRepository;
import um.ar.prog.repository.UserRepository;
import um.ar.prog.security.AuthoritiesConstants;
import um.ar.prog.service.UserService;
import um.ar.prog.service.dto.AdminUserDTO;
import um.ar.prog.service.dto.PasswordChangeDTO;
import um.ar.prog.service.dto.UserDTO;
import um.ar.prog.web.rest.vm.KeyAndPasswordVM;
import um.ar.prog.web.rest.vm.ManagedUserVM;
