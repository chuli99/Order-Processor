    ...
    <Row>
      <Col md="8">
        <h2 data-cy="ordenDetailsHeading">
          <Translate contentKey="orderProcessorApp.orden.detail.title">Orden</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dd>
            {ordenEntity.fechaOperacion ? (
              <TextFormat value={ordenEntity.fechaOperacion} type="date" format={APP_LOCAL_DATE_FORMAT} />
            ) : null}
          </dd>
          <dt>
            <span id="modo">
