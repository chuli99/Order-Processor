...
export const OrdenDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/orden' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="orderProcessorApp.orden.delete.question">
        <Translate contentKey="orderProcessorApp.orden.delete.question" interpolate={{ id: ordenEntity.id }}>
