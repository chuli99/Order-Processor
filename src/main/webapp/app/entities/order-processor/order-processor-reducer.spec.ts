...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORDERPROCESSOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_ORDERPROCESSOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ORDERPROCESSOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ORDERPROCESSOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ORDERPROCESSOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ORDERPROCESSOR actions', async () => {
      const expectedActions = [
        {
