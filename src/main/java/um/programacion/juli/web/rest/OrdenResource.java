...
import um.programacion.juli.service.OrdenService;
import um.programacion.juli.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link um.programacion.juli.domain.Orden}.
 */
@RestController
...
public class OrdenResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<Orden>> getAllOrdens(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
